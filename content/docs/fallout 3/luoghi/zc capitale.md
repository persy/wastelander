...
L'accampamento compagnia Artigli è una località non contrassegnata a sud-ovest della stazione fognaria e a sud-est di Megaton.
...
| Immagine                                     | Oggetto e posizione                                                                                               |
| -------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| {{<figure src="Tumblers_Today_Talon_Company_camp.webp">}}  | **Lo scassinatore moderno**, nell'[[#Accampamento compagnia Artiglio]] a sud-ovest, su uno scaffale del magazzino |
...
### Centrale elettrica MDPL-21
La centrale elettrica MDPL-21 si trova a nord-est del gruppo satelliti SatCom NN-03d.

| Mappa                    | Panoramica                     |
| ------------------------ | ------------------------------ |
| {{<figure src="MDPL_21_PS_loc.webp">}} | {{<figure src="MDPL21_power_station.webp">}} |

| Immagine                              | Oggetto e posizione                                                                                                                                           |
| ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| {{<figure src="MPL_21_Nikola_Tesla_and_You.webp">}} | **Tu e Nikola Tesla** e  **mina da tappo** , su un banco da lavoro sulla parete orientale della sottostazione                                                 |
| {{<figure src="DC_Journal_of_IM_MDPL_21_PS.jpg">}}  | **Giornale di medicina interna del D.C.**, a nord-est, su un tavolo in un rifugio di fortuna oltre un laghetto radioattivo, a ridosso del confine della mappa |
...
| {{<figure src="1st_Keller_family_transcript_bottom_shelf.webp">}}                  |  **Trascrizione famiglia Keller 1 di 5**, su una libreria nella [[#Capanna del traliccio]], che si trova sotto il terzo pilone partendo dalla centrale elettrica e andando verso nord                                                                                                                            |
...
- Per ottenere l'accesso all'armeria è necessario completare la missione nascosta *Rifugio della famiglia Keller*. I luoghi in cui trovare le cinque trascrizioni sono:
	- Centrale elettrica VAPL-58, nella [[#Capanna del traliccio]], su uno scaffale
	- [[#Cimitero di Hallowed Moors]], sul leggio della chiesa
	- [[#Grisly diner]], sul tavolo nel retro
	- [[#Baracca del cecchino]], sul banco da lavoro
	- [[#Anchorage Memorial]], vicino a un semirimorchio oltre il fiume, su un tavolo vicino a una radio
...
| {{<figure src="MDS_West_abandoned_shack_Nikola_Tesla_and_You.webp">}} | 2 **Tu e Nikola Tesla**: uno nella baracca nord, su un tavolo; l'altro a nord-est, nella [[#Tenda abbandonata]] |
...
*Vedi [[#Negozio del predatore]]*

Altri oggetti:
- Esterno
	- **Maschera da hockey di Ledoux**, indossata da Ledoux, ottenibile solo dopo aver preso la **Formula della Nuka-Cola Clear** dallo [[#Stabilimento Nuka-Cola]], in cambio di 250-400 tappi
		- Non è possibile fare lo scambio se si ha già portato a termine la missione *La sfida di Nuka Cola* per Sierra Petrovita
- Fabbrica
	- Orsacchiotto insolitamente grande,  un enorme triciclo sospeso sul soffitto vicino alla copia di **Elettronica di Dean**
- Uffici CEO
...
### Fort Bannister
Fort Bannister è una base militare prebellica e si trova a nord di Evergreen Mills e a sud dello smaltimento rifiuti  Jalbert Brothers. E' la base operativa dei mercenari della Talon Company.
...
| {{<figure src="Ft._Constantine_CO_quarters_Guns_and_bullets.webp">}}          | **Pistole e proiettili**, quartieri CO, sul letto matrimoniale                                                                                                                                                                                                             |
| {{<figure src="Ft._Constantine_CO_quarters_kitchen_Nuka-Cola_Quantum.webp">}} | **Nuka-Cola Quantum**, quartieri CO, in cucina nel frigorifero rotto                                                                                                                                                                                                       |
...
| Immagine                                       | Oggetto e posizione                                                                                                                                                |
| ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| {{<figure src="Duck_and_Cover!_Array,_Power_Station.webp">}} | Appena a nord del [[#Furgone che esplode dello scienziato]], giù nella valle vicino ad alcuni relitti d'auto, accanto a uno scheletro e delle scatole di munizioni |

*Vedi [[#Camion di internamento]]*
...
### Molo dei predoni di Meresti
Il molo dei predoni di Meresti è una località non contrassegnata e si trova appena ad ovest della stazione metropolitana di Meresti.
...
### Rifugio
Questo rifugio è una località non contrassegnata e si trova a sud dell'edificio Chryslus e ad est della stazione metropolitana Farragut West. L'ingresso è una porta sotto un ponte.
...
| {{<figure src="Hilltop_Farm_ruins_Guns_and_Bullets_near_farmhouse.webp">}} | **Pistole e proiettili**, nella latrina nelle [[#Rovine della fattoria sulla collina]] a sud-est                                    |
| {{<figure src="Hilltop_Farm_ruins_Dean's_Electronics.webp">}}              | **Elettronica di Dean**, su un barile di materiale nucleare a est delle [[#Rovine della fattoria sulla collina]]                    |
...
Il Rockland Car Tunnel è una sezione di un tunnel stradale crollato situato nell'angolo sud-ovest della Zona contaminata della Capitale. E' spesso infestata da da deathclaw o scorpioni radioattivi giganti.
...
| Immagine                                                                         | Oggetto e posizione                                                                                                                                                                                                         |
| -------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| {{<figure src="Bethesda_ruins_East_office_Bobblehead_-_Lockpick.webp">}}                  | **Bambolina - Scasso**, uffici Bethesda est, secondo livello, angolo sud-ovest della stanza con la torretta, su una scrivania accanto al terminale di controllo della torretta, accanto a una cassaforte a muro (Scasso 25) |
...
Vedi anche [[#Stazione della metro di Fairfax]]
...
### Stabilimento Nuka-Cola
Lo stabilimento Nuka-Cola è un grande edificio industriale a tre piani situato all'estremità meridionale ed è infestato  da nukalurks e protettori 
...
### Stazione di servizio Rockbreaker
...
*Vedi [[#Accampamento compagnia Artiglio]]*
...
*Vedi [[#Cratere del villaggio]]*





### Stazione ripetitore del satellite (Broken Steel)
...
It has one interior section. Altri oggetti:
- Taglia contenuto Una versione beta del cannone Tesla può essere trovata al di fuori dei confini della mappa. È ottenibile tramite alcuni salti piuttosto elaborati, costruendo una scala di munizioni, usando Dogmeat o comandi della console.

### Super-Duper Mart
Il Super-Duper Mart è un negozio di alimentari situato vicino al fiume Potomac,  a nord-est di Megaton e a nord-ovest di Grayditch. È completamente invaso dai predoni.
...
### Vault 87
Il Vault 87 si trova a nord-ovest di Little Lamplight e a sud-ovest della torre di trasmissione KT8. È il luogo di origine dei super mutanti e dei centauri della Zona contaminata della Capitale.
...
### Vault 92
Il Vault 92 si trova a nord-ovest del Vecchio Olney.
...
### Vault 106
è un Vault-Tec Vault situato nella Zona contaminata della Capitale nel 2277. Si trova all'interno di una grande caverna a sud-est di Arefu, direttamente a sud del Kaelyn's Bed & Breakfast, e un po 'a nord della stazione della metropolitana di Jury Street.
...
### Vault 108
è un Vault-Tec Vault situato nella Zona contaminata della Capitale nel 2277. Si trova a sud di Canterbury Commons e a nord-est della fabbrica Corvega.
