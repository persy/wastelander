...
[![Screenshot](./preview.png)](https://wastelander.netlify.app)

[Wastelander](https://wastelander.netlify.app) è un sito "bigino" che raccoglie tutte le informazioni essenziali per ogni giocatore di Fallout 3 e Fallout: New Vegas.

Il sito è stato costruito utilizzando solo software opensource (hugo + netlify) e i contenuti sono sotto licenza CC-BY-NC-ND-4.0.
